                        ...
                        <form action="Admin/Admin/Sua/{{$admin->id}}" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}" />
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" name="PhoneNumber" value="{{$admin->phonenumber}}" id="PhoneNumber"/>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                             ...
                             <div class="form-group">
                                <label>Name</label>
                                <input class="form-control" name="Name" value="{{$admin->name}}" id="Name"/>
                            </div>
                            <div id="ErrorUserName"></div>
                             <div class="form-group">
                                <label>Password</label>
                                <input class="form-control" name="password"   type="password" id="CreatePassword"/>
                            </div>
                             <div class="form-group">
